...
<?php
  ...
  $day = date('d'); //здесь исправлено с %d на d
  $mon = date('M'); //здесь исправлено с %B на M
  $year = date('Y'); //здесь исправлено с %Y на Y
?>
<!DOCTYPE html>
<html>
...
<body>
  ...
  <div id="content">
    ...
    <blockquote>
    <?php echo 'Сегодня ', $day, ' число, ', $mon, ' месяц, ', $year, ' год.'; ?>  <!-- Здесь функция strftime устарела -->
  </blockquote>
